...
func (tat *TestModule_avgTPS_Relay) writeToCSV() {
	...
	measureName := []string{"EpochID", "Equivalent committed tx # in this epoch", "Normal tx # in this epoch", "Relay1 tx # in this epoch", "Relay2 tx # in this epoch", "Epoch start time", "Epoch end time", "Avg. TPS of this epoch"}
