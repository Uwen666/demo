...
func (tctr *TestCrossTxRate_Relay) writeToCSV() {
	...
	measureName := []string{"EpochID", "Equivalent committed tx # in this epoch", "CTX # in this epoch", "Normal tx # in this epoch", "Relay1 tx # in this epoch", "Relay2 tx # in this epoch", "CTX ratio of this epoch"}
